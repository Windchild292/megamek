...
public class Infantry extends Entity {
  ...
  */
    ...
    public double getDamagePerTrooper() {
        ...
        double adjustedDamage = Math.min(MegaMekConstants.PRIMARY_WEAPON_DAMAGE_CAP, primaryW.getInfantryDamage());
    ...
    public boolean primaryWeaponDamageCapped() {
        return getPrimaryWeaponDamage() > MegaMekConstants.PRIMARY_WEAPON_DAMAGE_CAP;
    }
