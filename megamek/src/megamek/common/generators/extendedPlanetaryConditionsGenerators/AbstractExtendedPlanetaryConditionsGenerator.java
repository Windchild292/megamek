 ...
 *
 * The generated conditions may include planetary values (atmosphere, gravity, temperature) if the
...
public abstract class AbstractExtendedPlanetaryConditionsGenerator {
     ...
     * @param constantPlanetaryValues ensures planetary values (atmosphere, gravity, temperature)
     *                                are kept constant when true
     */
