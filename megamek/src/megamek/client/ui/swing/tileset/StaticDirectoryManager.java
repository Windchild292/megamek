...
public class StaticDirectoryManager {
    ...
    private StaticDirectoryManager() {
    ...
    private static void initializeCamouflage() {
        ...
        if (parseCamouflageDirectory) {
            ...
            try {
                ...
                MegaMek.getLogger().error(StaticDirectoryManager.class, "Could not parse the camo directory!");
                MegaMek.getLogger().error(StaticDirectoryManager.class, e);
    ...
    private static void initializePortraits() {
        ...
        if (parsePortraitDirectory) {
            ...
            try {
                ...
                MegaMek.getLogger().error(StaticDirectoryManager.class, "Could not parse the portraits directory!");
                MegaMek.getLogger().error(StaticDirectoryManager.class, e);
            }
        }
    }
