...
public abstract class AbstractImagePanel extends JPanel {
    private final DirectoryItems imageDirectory;
    private AbstractIcon icon;

    private JLabel lblImage;

    protected AbstractImagePanel(DirectoryItems imageDirectory) {
        this(imageDirectory, null, "");
    }

    protected AbstractImagePanel(DirectoryItems imageDirectory, AbstractIcon icon, String panelName) {
    ...
    protected DirectoryItems getImageDirectory() {
    ...
    public void updatePanel() {
        lblImage.setIcon(getIcon().getImageIcon(getImageDirectory()));
    }
}
